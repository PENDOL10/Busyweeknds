             ...
             <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                 ...
                 <div class="lg:col-span-1 space-y-6">
                     <div class="bg-white rounded-lg p-6">
                         <h3 class="text-lg font-semibold text-gray-900 mb-6">Upload Image</h3>
                         <div class="border-2 border-dashed border-gray-200 rounded-lg p-8 text-center cursor-pointer hover:border-blue-300 transition-colors"
                             ...
                             <div class="space-y-3">
                                 ...
                                 <div>
                                     <p class="text-sm font-medium text-gray-900">Upload a Photo</p>
                         ...
                         <div id="image-preview-container" class="mt-4 hidden">
                             <img id="image-preview" class="rounded-lg w-full h-auto" src="#" alt="Image Preview">
                         </div>
                     </div>
